export const MSG_CONSTANTS = Object.freeze({
    ...
    _incorrect_email_msg: 'Debe ingresar un correo válido.',
    _empty_email_msg: 'Debe ingresar un correo.',
    _incorrect_language_msg: 'Debe seleccionar un idioma',
    _incorrect_visibility_msg: 'Debe seleccionar la visibilidad',
    _incorrect_date_msg: 'Ingrese una fecha correcta',
});