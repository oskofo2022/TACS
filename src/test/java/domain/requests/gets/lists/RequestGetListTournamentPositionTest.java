...
public class RequestGetListTournamentPositionTest extends RequestGetListOnMemoryPagedListTest<Tournament, RequestGetListTournamentPosition> {
    ...
    @Override
    protected RequestGetListTournamentPosition createValidRequest() {
        return new RequestGetListTournamentPosition();
    }
}